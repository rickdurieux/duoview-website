        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-16 lg:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-700">
              Sterke visuals voor online campagnes, social content en
              merkverhalen.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div className="max-w-3xl">
            <p className="text-base leading-8 text-slate-700 sm:text-lg">
              Van hero shots tot korte social-first video&apos;s: wij maken
              beelden die snel de aandacht pakken en professioneel inzetbaar
              zijn.
            </p>
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white/90 p-8 shadow-[0_18px_45px_rgba(148,163,184,0.14)] backdrop-blur-sm">
            ...
            <h2 className="mt-4 text-2xl font-semibold text-slate-900">
              Visuals die direct campagnekracht geven
            </h2>
            <p className="mt-4 text-base leading-7 text-slate-700">
              Snel, scherp en professioneel beeldmateriaal voor campagnes die
              moeten opvallen en blijven hangen.
            </p>
          </div>
        </div>
      </section>
